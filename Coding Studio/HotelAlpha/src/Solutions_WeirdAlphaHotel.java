...
public class Solutions_WeirdAlphaHotel {
     ...
     *                      another guest.
     */
    public Solutions_WeirdAlphaHotel(int numberOfRooms, int probingLength) {
     ...
     * Default constructor
     */
    public Solutions_WeirdAlphaHotel() {
    ...
    public static void main(String[] args) {
        ...
        Solutions_WeirdAlphaHotel test = new Solutions_WeirdAlphaHotel(testHotelSize, testProbingLength);
