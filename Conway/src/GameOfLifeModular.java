...
public class GameOfLifeModular {

    private boolean[][] currentUniverse, nextUniverse;
    private int N;

    public GameOfLifeModular(int N) {
        this.N = N;
        currentUniverse = new boolean[N][N];
        nextUniverse = new boolean[N][N];
    }
