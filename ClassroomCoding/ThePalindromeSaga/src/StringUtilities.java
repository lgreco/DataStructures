...
public class StringUtilities {
    ...
    /** Performance counter for naive (inefficient) method isPalindrome */
    static int equalityOpUsageWithForLoop = 0;

    /** Performance counter for efficient method isPalindrome2 */
    static int equalityOpUsageWithWhileLoop = 0;
    ...
    static boolean isPalindrome2(String string) {
        ...
        while (result && i < string.length()/2) { // Stop when different letters found or when reaching middle of string
            ...
            equalityOpUsageWithWhileLoop++; // update efficiency counter
    ...
    /**
     * Method to display iterations performed by the for-loop-based method and the while-loop-based method.
     */
    static void reportUsage() {
        System.out.printf("\nThe method with the for loop made %d calls to the == operator.", equalityOpUsageWithForLoop);
        System.out.printf("\nthe method with the while loop made %d calls to the == operator.", equalityOpUsageWithWhileLoop);
    } // method reportUsage
